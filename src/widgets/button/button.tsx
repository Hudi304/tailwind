...
const ButtonVariantClasses: Record<ButtonVariants, string> = {
  danger: "button-base-danger",
  ghost: "button-base-ghost",
  primary: "button-base-primary",
  secondary: "button-base-secondary",
  // 'button-base-secondary-vanilla',
  success: "button-base-success",
}
...
const Button = ({
  ...
  return (
    <button className={`button-base ${typographyVariantClassName}  ${className}`} {...props}>
      {children}
    </button>
  )
}
